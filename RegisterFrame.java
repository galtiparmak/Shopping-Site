...
/**
 * Book cathegory.
 * @author Gökberk Altıparmak, Osman Baktır
    ...
    class MyActionListener1 implements ActionListener
    {
        ...
        public void actionPerformed( ActionEvent e )
        {
            if ( e.getSource() == loginButton )
            {
                ...
                //new MainFrame(); // Zeynep Userın bilgilerini data baseden çağırıp burada user objesi oluşturup onu parametresi olarak frame ekliyeceksin.
            }
